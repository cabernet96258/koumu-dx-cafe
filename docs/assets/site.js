(function () {
  ...
  /* ── きょうのひとやすみ ─────────────────────────────────────────────── */
  /* Each entry must be 50 characters or fewer (desktop shows one line with
     ellipsis truncation, so anything longer gets visibly cut off there). */
  ...
  var RESTS = [
    ...
    "ブラックと微糖を使い分けよう。",
    "授業も仕事もうまい先生を真似よう。工夫の先に、自分らしさが生まれる。"
  ];
